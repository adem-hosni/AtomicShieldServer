...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('anticheat', '0035_anticheatversion_is_current_version_and_more'),
    ...
    operations = [
        migrations.AddField(
            ...
            name='entity',
            field=models.IntegerField(choices=[(1, 'FxServer'), (2, 'Agent'), (3, 'Engine')], default=None),
            preserve_default=False,
        ),
        migrations.CreateModel(
            name='HistoricalClientHWID',
            fields=[
