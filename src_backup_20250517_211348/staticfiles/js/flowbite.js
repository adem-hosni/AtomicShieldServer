...
var Default = {
    ...
    backdropClasses: 'bg-gray-900/50 dark:bg-black/80 fixed inset-0 z-30',
    onShow: function () { },
    onHide: function () { },
    onToggle: function () { },
};
...
var Default = {
    defaultTabId: null,
    activeClasses: 'text-purple-600 hover:text-purple-600 dark:text-purple-500 dark:hover:text-purple-500 border-purple-600 dark:border-purple-500',
